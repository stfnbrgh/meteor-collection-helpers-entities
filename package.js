Package.describe({
    ...
    summary: 'Register multiple helpers for an entity to attach on multiple collections or levels of the same document',
...
Package.onUse(function (api) {
    ...
    api.use("stfnbrgh:nested-collection-helpers");
